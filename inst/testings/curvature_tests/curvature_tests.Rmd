...
devtools::load_all()  # library(rcell2.examples)
...
```{r}
data.dir <- "data/time_series_sample/"
...
```{r}
cell.out <- cell.args %>%
  cell2(output_coords_to_tsv = T, dry = T)
```
...
saveRDS(cell.data,
        paste0(tmp_dir, "cell.data.RDS"))
saveRDS(cell.boundaries,
        paste0(tmp_dir, "cell.boundaries.RDS"))
saveRDS(cell.boundaries.list,
        paste0(tmp_dir, "cell.boundaries.list.RDS"))
saveRDS(cell.perims.list,
        paste0(tmp_dir, "cell.perims.list.RDS"))
saveRDS(cell.perims,
        paste0(tmp_dir, "cell.perims.RDS"))
saveRDS(cell.perims.smooth,
        paste0(tmp_dir, "cell.perims.smooth.RDS"))
saveRDS(cell.perim.angles,
        paste0(tmp_dir, "cell.perim.angles.RDS"))
saveRDS(cell.angles.sd,
        paste0(tmp_dir, "cell.angles.sd.RDS"))
```
...
Cross-correlation of a trace ith itself:
...
#### Distancias y clustering para DTW
